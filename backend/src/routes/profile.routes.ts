...
router.put("/me", authenticate, doubleCsrfProtection, ProfileController.updateProfile);
...
router.post("/link", authenticate, doubleCsrfProtection, ProfileController.addLink);
